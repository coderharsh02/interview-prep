...
Sure! I'm Harsh Shah, currently working as an Associate Software Engineer at Radix Software Services in Ahmedabad. I have almost 3 years of experience in full-stack development, mainly using .NET, Angular, and SQL Server. My role involves designing APIs, implementing complex business logics, and integrating front-end components using Angular.
